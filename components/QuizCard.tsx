...
export const QuizCard: React.FC<QuizCardProps> = ({ quiz, onStart }) => {
  return (
    ...
    >
      <div>
        <h3 className="text-blue-900 text-2xl font-bold mb-4 text-center">{quiz.title}</h3>
      ...
      <button 
        className="bg-gradient-to-r from-blue-500 to-sky-500 text-white border-none py-3 px-6 rounded-full text-base cursor-pointer w-full transition-all duration-300 font-bold mt-2.5 hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(59,130,246,0.4)]"
      >
        ابدأ الاختبار
      </button>
    </div>
