...
export const ResultsView: React.FC<ResultsViewProps> = ({ quiz, userAnswers, timeTaken, onReview, onBack }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl text-center">
      <h3 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-4">انتهى الاختبار!</h3>
      <div className="text-5xl sm:text-6xl font-extrabold text-blue-500 my-5">{score} / {total}</div>
